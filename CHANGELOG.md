...
<div>
  <div lang="en">
    <h2>v.18.1.1 - June 2026</h2>
    <ul>
      <li>Upgraded dependency: Axios</li>
    </ul>
    <h2>v.18.1.0 - May 2026</h2>
    <ul>
      <li>Upgraded dependency: Axios</li>
    </ul>
    <h2>v.18.0.0 - April 2026</h2>
    <ul>
      <li>Migration guide to new design system</li>
      <li>Deprecated: CommandBar</li>
      <li>Deprecated: Grid</li>
      <li>Upgraded dependency: Axios</li>
    </ul>
    ...
    <h2>v.16.0.3 - September 2025</h2>
    <ul>
      <li>Upgraded dependency: axios</li>
    </ul>
    <h2>v.16.0.2 - July 2025</h2>
    <ul>
      <li>Upgraded dependency: axios</li>
    </ul>
    <h2>v.16.0.1 - March 2025</h2>
    <ul>
      <li>Upgraded dependency: axios</li>
    </ul>
    <h2>v.16.0.0 - March 2025</h2>
    <ul>
      <li>Migration guide: ProgressBar</li>
      <li>Upgraded dependency: axios</li>
    </ul>
