...
<>
  ...
  <p>
   Sidevelgeren legger til rette for at brukeren kan bla i stedet 
for å måtte skrolle nedover i lange lister og tabeller med opplysninger. 
Komponenten hører alltid sammen med en annen komponent – som regel tabell 
eller søkeresultat.
  </p>
...
komponenten (tabell eller søkeresultat). 
    ...
    <li>
      Når du stiller inn tallet på sider i tallrekken der brukeren blar 
fra, skal du ta hensyn til hvor mye data som vises og sannsynligheten for 
at brukeren vil bla i opplysningene 
    </li>
<li>
  På mobil anbefaler vi å ikke ha flere enn tre tall synlig i tallrekken 
på grunn av plassen på skjermen.
   </li>
  </ul>
</>
```
