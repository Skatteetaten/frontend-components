...
export interface ModalProps {
  ...
  name: string;
  /** Mulighet til å angi shadowRoot til en custom node Modal'en skal instansieres i. Dersom den inneholder en id="style-injector" vi modal-wrapper være nested der */
