...
<Layout>
  ...
  <Main>
    <Nav lg={12} xl={2}>
      <Card title="Part" color={Card.GREEN}>
        Innhold
      </Card>
    </Nav>
    <Article lg={12} xl={8}>
      <Card title="Kjerne 1" color={Card.GREY}>
        Innhold
      </Card>
    </Article>
    <Aside lg={12} xl={2}>
      <Card title="Rutiner" color={Card.BEIGE}>
        Innhold
      </Card>
    </Aside>
  </Main>
...
<Layout>
  ...
  <Main>
    <Nav lg={12} xl={2}>
      <Card title="Part" titlesize="large" color={Card.GREEN}>
        Innhold
      </Card>
    </Nav>
    <Article lg={12} xl={10}>
      <Card title="Navn på arbeidsoppgave" color={Card.GREY}>
        Innhold
      </Card>
      <Card
