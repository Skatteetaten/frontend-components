...
For full API-dokumentasjon, vennligst se på [RadioGroup komponent](https://www.skatteetaten.no/stilogtone/designsystemet/komponenter/radiobutton/) på dokumentasjonssiden til designsystemet.
